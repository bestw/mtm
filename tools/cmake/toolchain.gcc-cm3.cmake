# arm-none-eabi-gcc toolchain for cortex-m3
# Creator: WANG Jun
# Created Time: 2017-07-07
# Last Change: 2017-07-25
#
# update:
# 2017-07-20    WANG Jun    add -std=, -DDEBUG...
# 2017-07-25    WANG Jun    add CMAKE_SIZE, modified FLAGS

if(__GCC_CM3_TOOLCHAIN_INCLUDED)
    return()
endif()
set(__GCC_CM3_TOOLCHAIN_INCLUDED TRUE)
...
set(CMAKE_C_FLAGS "-std=c99 -mthumb -mcpu=cortex-m3 -Wall -ffunction-sections -fdata-sections")
set(CMAKE_C_FLAGS_DEBUG "-O0 -g -gdwarf-2 -DDEBUG")
set(CMAKE_C_FLAGS_RELEASE "-O2")

set(CMAKE_ASM_FLAGS "-mthumb -mcpu=cortex-m3 -Wall -ffunction-sections -fdata-sections -x assembler-with-cpp")
set(CMAKE_ASM_FLAGS_DEBUG "-g -gdwarf-2 -DDEBUG")
set(CMAKE_ASM_FLAGS_RELEASE "")

set(CMAKE_CXX_FLAGS "-std=c++11 -mthumb -mcpu=cortex-m3 -Wall -ffunction-sections -fdata-sections")
